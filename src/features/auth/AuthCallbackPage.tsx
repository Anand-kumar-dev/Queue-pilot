  ...
  return (
    <AuthLayout>
      {callbackError || settledWithoutUser ? (
        <div>
          <p className="technical-label">Account / callback</p>
          <h2 className="mt-4 text-[30px] font-medium leading-tight tracking-[-0.035em] text-ink">Sign-in could not be completed</h2>
